...
namespace Silkroad.SecurityAPI
{
    public class Security
    {
        ...
        void GenerateSecurity(SecurityFlags flags)
        {
            ...
            {
                m_initial_blowfish_key = NextULong();
            ...
            {
                m_handshake_blowfish_key = NextULong();
                m_value_x = NextUInt() & 0x7FFFFFFF;
                m_value_g = NextUInt() & 0x7FFFFFFF;
                m_value_p = NextUInt() & 0x7FFFFFFF;
        ...
        /// <summary>
        /// Changes the 0x2001 identify packet data that will be sent out by this security object.
        /// </summary>
        ...
        /// <summary>
        /// Generates the security settings.
        /// This should only be called if the security object is being used to process an incoming connection's data (server).
        /// </summary>
        ...
        /// <summary>
        /// Adds an encrypted opcode to the API. Any opcodes registered here will automatically be encrypted as needed.
        /// Users should add the current Item Use opcode if they will be mixing security modes.
        /// </summary>
        ...
        /// <summary>
        /// Queues a packet for processing to be sent.
        /// The data is simply formatted and processed during the next call to TransferOutgoing.
        /// </summary>
